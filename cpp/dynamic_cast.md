...
#### 为什么需要 dynamic_cast
看cpprefernece中描述dynamic_cast能实现的功能，只有的第4条、第5条是dynamic_cast独有的。


但是dynamic_cast能做void-convert，以及在downcast时做运行时检查，以及能做一个sidecast。
...
#### dynamic_cast的类型一定需要有虚函数么？
不需要，没有虚函数的继承关系一样可用dynamic_cast进行转换。
